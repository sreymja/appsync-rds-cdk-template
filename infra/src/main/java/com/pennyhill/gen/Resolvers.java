        ...
        return List.of(
            ...
            BaseResolverProps.builder()
                ...
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                            "select * from audits where id = :ID" ), List.of(
...
,             BaseResolverProps.builder()
                ...
                .typeName("Query")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                            "select * from categories where id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build(), 
            BaseResolverProps.builder()
                ...
                .typeName("Query")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                            "select * from categories" ), List.of(
))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build()
,             BaseResolverProps.builder()
...
,             BaseResolverProps.builder()
                ...
                .typeName("Query")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                            "select * from priorities where id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build(), 
            BaseResolverProps.builder()
                ...
                .typeName("Query")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                            "select * from priorities" ), List.of(
))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build()
,             BaseResolverProps.builder()
...
,             BaseResolverProps.builder()
                ...
                .typeName("Query")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                            "select * from users where id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build(), 
            BaseResolverProps.builder()
...
,
            ...
            BaseResolverProps.builder()
                ...
                .typeName("User")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                        "select * from audits where user_id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build()
 , 
            BaseResolverProps.builder()
                ...
                .typeName("Ticket")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                        "select * from comments where ticket_id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build(), 
            BaseResolverProps.builder()
                ...
                .typeName("User")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                        "select * from comments where user_id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build()
 , 
            ...
            BaseResolverProps.builder()
                ...
                .typeName("Priority")
                .requestMappingTemplate(MappingTemplate.fromString(requestTemplate(false, List.of(
                        "select * from tickets where priority_id = :ID" ), List.of(
                            "\":ID\":$util.toJson($ctx.args.id)" ))))
                .responseMappingTemplate(MappingTemplate.fromString(RESPONSE_TEMPLATE))
                .build(), 
            BaseResolverProps.builder()
